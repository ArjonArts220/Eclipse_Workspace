...
void Mobiel::setProvider(Provider *p){
	(m_pProvider) = p;
}
...
//void Mobiel::writeWhatsappSms(int nr, std::string message){
//	m_pSms = new Sms(m_nNumber, nr, message);
//	m_pProvider->writeSms(nr, m_pSms);
//}
//
//void Mobiel::writeMessengerSms(int nr, std::string message){
//	m_pSms = new Sms(m_nNumber, nr, message);
//	m_pProvider->writeSms(nr, m_pSms);
//}
